...
exports.addCar = (req, res) => {
    ...
    const sql = 'INSERT INTO cars (name, year, photo, description, km, model, power, fuel) VALUES (?, ?, ?, ?, ?, ?, ?, ?)';
    db.query(sql, [name, year, photo, description, km, model, power, fuel], (err, result) => {
        if (err) {
